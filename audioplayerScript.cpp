...
ListBox1->Items->Add(ExtractFileName(OpenDialog1->FileName));
   ...
   //открываетс€ компонент opendialog и выбираетс€ mp3 файл
...
MediaPlayer1->Position = MediaPlayer1->Length*ScrollBar1->Position/100;
   ...
   //если объект изменилс€ не из-за таймер, то останавливаем плеер,
   //мен€ем врем€ проигрывани€ пропорцинально длинее   scrollbar
   // запускаем плеер
