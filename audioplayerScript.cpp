...
MediaPlayer1->Position = MediaPlayer1->Length*ScrollBar1->Position/100;
   ...
   //меняем время проигрывания пропорцинально длинее   scrollbar
   // запускаем плеер
...
void __fastcall TForm1::Timer1Timer(TObject *Sender)
{
   ...
   //изменение позиции по таймеру каждую секунду пропорцианально длинне дорожки mp3
}
//---------------------------------------------------------------------------
void __fastcall TForm1::MediaPlayer1Click(TObject *Sender,
      TMPBtnType Button, bool &DoDefault)
{         //функция настройки кнопок объета mediaplayer
// при play  - музыка проигрывается
 MediaPlayer1->Play();
